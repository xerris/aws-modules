...
resource "aws_lambda_function" "function_custom_auth" {
  ...
  function_name    = "apigw-custom-auth-${var.apigateway_name}"
...
resource "aws_iam_role" "lambda_exec" {
  ...
  name = "apigw-custom-auth-role-${var.apigateway_name}"
...
resource "aws_iam_role" "invocation_role" {
  ...
  name = "apigw_custom_auth_invocation-${var.apigateway_name}"
  path = "/"
...
resource "aws_iam_role_policy" "invocation_policy" {
  ...
  name = "apigw-custom-auth-invocation-${var.apigateway_name}"
